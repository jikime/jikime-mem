...
skills: [jikime-tool-ast-grep, jikime-workflow-testing, jikime-foundation-quality]
hooks:
  PostToolUse:
    - matcher: "Write|Edit"
      hooks:
        - type: command
          command: "uv run \"{{PROJECT_DIR}}\"/.claude/hooks/jikime/post_tool__lsp_diagnostic.py"
          timeout: 30
        - type: command
...
Required Skill: jikime-tool-ast-grep
