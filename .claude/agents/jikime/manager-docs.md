...
skills: jikime-foundation-claude, jikime-foundation-core, jikime-library-mermaid, jikime-library-nextra, jikime-formats-data, jikime-docs-generation, jikime-workflow-jit-docs
---
...
- jikime-foundation-core: SPEC-first DDD, TRUST 5 framework, execution rules
- jikime-workflow-docs: Documentation workflow, validation scripts
- jikime-library-mermaid: Mermaid diagram creation and validation
- jikime-foundation-claude: Claude Code authoring patterns, skills/agents/commands
- jikime-library-nextra: Nextra framework setup and optimization

# Conditional skills (auto-loaded by Alfred when needed)
conditional_skills = [
"jikime-domain-uiux", # WCAG compliance, accessibility patterns, Figma integration
"jikime-lang-python", # Python documentation patterns
"jikime-lang-typescript", # TypeScript documentation patterns
"jikime-workflow-project", # Project documentation management
"jikime-ai-nano-banana" # AI content generation
]
```
...
### 1. JikiME-ADK Ecosystem Integration

**JikiME-ADK Component Integration Workflow:**

Coordinate documentation workflows with existing JikiME-ADK components:
...
- **Documentation Synchronization**: Sync Nextra docs with .jikime/docs/ directory structure
...
- workflow-ddd: Documentation generation after DDD implementation completes
