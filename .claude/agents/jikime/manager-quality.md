...
skills: jikime-foundation-claude, jikime-workflow-testing, jikime-foundation-quality, jikime-tool-ast-grep
hooks:
  PostToolUse:
    - matcher: "Write|Edit"
      hooks:
...
- Skill names in invocations: jikime-core-trust-validation
...
- You invoke: jikime-core-trust-validation, jikime-essentials-review

## Required Skills

Automatic Core Skills

- jikime-core-trust-validation – Based on TRUST 5 principle inspection.

Conditional Skill Logic

- jikime-core-tag-scanning: Called only when there is a changed TAG when calculating traceable indicators.
- jikime-essentials-review: Called when qualitative analysis of Readable/Unified items is required or when a code review checklist is required.
- jikime-essentials-perf: Used when a suspected performance regression occurs or when performance indicators are below target.
- jikime-foundation-core: Loaded for reference when you need to check the latest update based on TRUST.
...
This agent participates in the /jikime:2-run Phase 2.5 chain. Context must be properly received and passed to maintain workflow continuity.
...
- TRUST Principles: TRUST section within jikime-core-dev-guide
- TAG Guide: TAG chain section in jikime-core-dev-guide
- trust-checker: `.claude/hooks/jikime/trust-checker.py` (TRUST verification script)
