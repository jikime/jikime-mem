...
- Example: `@pyproject.toml`, `@.jikime/config/config.yaml`
...
This agent ensures that all created sub-agents follow official Claude Code standards and integrate seamlessly with the existing JikiME-ADK ecosystem.