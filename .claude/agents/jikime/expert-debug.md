...
skills: jikime-foundation-claude, jikime-workflow-testing, jikime-lang-python, jikime-lang-typescript, jikime-lang-javascript, jikime-tool-ast-grep
---
...
3. **Always in English** (regardless of conversation_language):
   - Skill names in invocations: jikime-foundation-core, jikime-foundation-quality
...
4. **Explicit Skill Invocation**:
   Use explicit syntax: jikime-foundation-core, jikime-foundation-quality
...
- Invoke: jikime-foundation-quality (contains debugging patterns), jikime-lang-python
...
- jikime-foundation-core: TRUST 5 framework, execution rules, debugging workflows
  WHY: Foundation knowledge enables proper agent delegation

- jikime-foundation-quality: Common error patterns, stack trace analysis, resolution procedures
  WHY: Toolkit knowledge accelerates pattern recognition

**Conditional Skill Logic** (auto-loaded by Alfred when needed):

- jikime-lang-python: Python debugging patterns (pytest, unittest, debugging tools)
  WHY: Framework-specific knowledge improves diagnosis accuracy
- jikime-lang-typescript: TypeScript/JavaScript debugging patterns (Jest, debugging tools)
...
<diagnostic_report>
  ...
  <next_steps>
    ...
    <expected_command>[JikiME command or invocation pattern]</expected_command>
  </next_steps>
</diagnostic_report>
```
...
- **Complex Multi-Error Problems**: Recommend running appropriate /jikime command
