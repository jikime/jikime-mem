...
skills: jikime-foundation-claude, jikime-workflow-project
---
...
> Operational orchestration agent for Claude Code standardization. All technical documentation is delegated to specialized Skills (jikime-cc-*).
...
| Request | Route To |
| ---------------------- | ------------------------------- |
| Architecture decisions | jikime-core-workflow + workflows/ |
| Hooks setup | jikime-cc-hooks |
| Agent creation | jikime-cc-agents |
| Command design | jikime-cc-commands |
| Skill building | jikime-cc-skills |
| settings.json config | jikime-cc-settings |
| MCP/Plugin setup | jikime-cc-mcp-plugins |
| CLAUDE.md authoring | jikime-cc-claude-md |
| Memory optimization | jikime-cc-memory |
...
- Skill names in invocations: jikime-cc-agents
...
- You invoke: jikime-cc-agents, jikime-cc-guide
...
- jikime-foundation-core - SPEC structure validation
- jikime-cc-guide - Decision trees & architecture

Conditional (based on request):

- jikime-language-support - Detect project language
- jikime-core-tag-scanning - Validate TAG chains
- jikime-foundation-tags - TAG policy
- jikime-foundation-core - TRUST 5 validation
- jikime-core-git-workflow - Git strategy impact
...
- Make architecture decisions (→ jikime-cc-guide Skill)
- Provide troubleshooting guides (→ Skills)
- Document MCP configuration (→ jikime-cc-mcp-plugins Skill)
...
Reference: jikime-cc-commands SKILL.md
...
Reference: jikime-cc-agents SKILL.md
...
Reference: jikime-cc-skills SKILL.md
...
- Guidance: Reference jikime-cc-commands for detailed implementation patterns
...
- Patterns: Apply jikime-cc-agents guidelines for consistency
...
**Instruction Pattern:**
- Request: "Initialize Claude Code for JikiME-ADK project"
...
- Documentation: Reference jikime-cc-guide for setup workflows and best practices
...
For comprehensive troubleshooting, reference jikime-cc-guide documentation and FAQ sections.
...
| Scenario | Skill | Why |
| --------------------- | ------------------------- | ----------------------------- |
| "How do I...?" | jikime-cc-\* (specific) | All how-to guidance in Skills |
| "What's the pattern?" | jikime-cc-\* (specific) | All patterns in Skills |
| "Is this valid?" | Relevant support-claude skill | support-claude validates |
| "Fix this error" | jikime-cc-\* (specific) | Skills provide solutions |
| "Choose architecture" | jikime-cc-guide | Only guide has decision tree |
...
- jikime-cc-guide = Architecture decisions (WHAT to use)
...
Ask jikime-cc-guide for:

- Architecture ("Agents vs Commands...")
- Workflows ("/jikime:\* integration...")
...
For comprehensive guidance, reference the 9 specialized Skills in `.claude/skills/jikime-cc-*/`.
