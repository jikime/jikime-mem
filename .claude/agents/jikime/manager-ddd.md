...
skills: jikime-foundation-claude, jikime-workflow-ddd, jikime-tool-ast-grep, jikime-workflow-testing, jikime-foundation-quality
hooks:
  PostToolUse:
    - matcher: "Write|Edit"
      hooks:
...
- New feature development (delegate to manager-ddd)
...
- New features needed: Delegate to manager-ddd (DDD is for structure, not features)
...
- Skills from YAML frontmatter: jikime-workflow-ddd, jikime-tool-ast-grep, jikime-workflow-testing

Example:

- Receive (Korean): "Refactor SPEC-REFACTOR-001 to improve module separation"
- Skills pre-loaded: jikime-workflow-ddd (DDD methodology), jikime-tool-ast-grep (structural analysis), jikime-workflow-testing (characterization tests)
...
- jikime-workflow-ddd: DDD methodology and ANALYZE-PRESERVE-IMPROVE cycle
- jikime-tool-ast-grep: AST-based structural analysis and code transformation
- jikime-workflow-testing: Characterization tests and behavior verification

Conditional Skills (auto-loaded by Alfred when needed):

- jikime-workflow-project: Project management and configuration patterns
- jikime-foundation-quality: Quality validation and metrics analysis
