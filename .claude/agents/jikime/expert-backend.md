...
skills: jikime-foundation-claude, jikime-lang-python, jikime-lang-typescript, jikime-lang-javascript, jikime-domain-backend, jikime-domain-database, jikime-platform-supabase, jikime-platform-neon, jikime-tool-ast-grep
hooks:
  PreToolUse:
    - matcher: "Write|Edit"
      hooks:
        - type: command
          command: "uv run \"{{PROJECT_DIR}}\"/.claude/hooks/jikime/pre_tool__security_guard.py"
          timeout: 30
  PostToolUse:
    - matcher: "Write|Edit"
      hooks:
        - type: command
          command: "uv run \"{{PROJECT_DIR}}\"/.claude/hooks/jikime/post_tool__ast_grep_scan.py"
          timeout: 60
---
...
- jikime-foundation-claude – Core execution rules and agent delegation patterns
- jikime-lang-python – Python/FastAPI/Django/Flask patterns
- jikime-lang-typescript – TypeScript/Node.js/Express/NestJS patterns
- jikime-domain-backend – Backend infrastructure, databases, authentication, microservices architecture

Conditional Skills (auto-loaded by Alfred when needed)

- jikime-foundation-core – TRUST 5 framework and quality gates
...
Python Frameworks: FastAPI, Flask, Django patterns provided by jikime-lang-python

TypeScript Frameworks: Express, Fastify, NestJS, Sails patterns provided by jikime-lang-typescript

Go Frameworks: Gin, Beego patterns provided by jikime-lang-go

Rust Frameworks: Axum, Rocket patterns provided by jikime-lang-rust

Java Frameworks: Spring Boot patterns provided by jikime-lang-java

PHP Frameworks: Laravel, Symfony patterns provided by jikime-lang-php
...
[HARD] Use jikime-domain-backend skill for backend infrastructure patterns
...
1. [HARD] Read SPEC Files: Access `.jikime/specs/SPEC-{ID}/spec.md`
...
Create `.jikime/docs/backend-architecture-{SPEC-ID}.md`:
...
- jikime-lang-python – Python/FastAPI/Django/Flask patterns
- jikime-lang-typescript – TypeScript/Node.js/Express/NestJS patterns
- jikime-domain-backend – Backend infrastructure, databases, authentication, microservices

Conditional Skills (loaded by Alfred when needed):

- jikime-foundation-core – MCP server integration patterns
