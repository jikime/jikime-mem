...
skills: jikime-foundation-claude, jikime-lang-python, jikime-lang-typescript, jikime-lang-javascript, jikime-workflow-testing, jikime-foundation-quality, jikime-tool-ast-grep
---
...
- jikime-lang-python – Python/pytest/unittest testing patterns
- jikime-lang-typescript – TypeScript/Jest/Vitest/Playwright testing patterns
- jikime-workflow-testing – Testing strategies and comprehensive test patterns
- jikime-foundation-quality – Quality gates and TRUST 5 framework

Conditional Skills (auto-loaded by Alfred when needed)
- jikime-foundation-core – SPEC integration and workflow patterns
...
Create `.jikime/docs/test-strategy-{SPEC-ID}.md`:
...
- jikime-lang-python – Python/pytest/unittest testing patterns
- jikime-lang-typescript – TypeScript/Jest/Vitest/Playwright testing patterns
- jikime-workflow-testing – Comprehensive testing strategies and patterns
- jikime-foundation-quality – Quality gates and TRUST 5 framework

Conditional Skills (loaded by Alfred when needed):
- jikime-workflow-testing – Testing patterns and automation workflows
