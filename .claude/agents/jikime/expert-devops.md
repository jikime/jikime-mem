...
skills: jikime-foundation-claude, jikime-workflow-project, jikime-workflow-jit-docs, jikime-platform-vercel, jikime-platform-railway
---
...
- jikime-workflow-project – Project configuration and deployment workflows
...
- jikime-platform-vercel – Vercel edge deployment patterns for Next.js and React applications
...
- jikime-platform-railway – Railway container deployment patterns for full-stack applications
...
- jikime-foundation-core – TRUST 5 framework for infrastructure compliance
...
1. Read SPEC Files: `.jikime/specs/SPEC-{ID}/spec.md`
...
4. Use Skills: jikime-platform-vercel, jikime-platform-railway (from YAML frontmatter) provide platform-specific deployment patterns
...
- jikime-workflow-project – Project configuration and deployment workflows
- jikime-workflow-jit-docs – Documentation generation and synchronization
- jikime-platform-vercel – Vercel edge deployment for Next.js/React applications
- jikime-platform-railway – Railway container deployment for full-stack applications
