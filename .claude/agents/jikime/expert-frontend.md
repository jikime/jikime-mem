...
skills: jikime-foundation-claude, jikime-lang-typescript, jikime-lang-javascript, jikime-domain-frontend, jikime-domain-uiux, jikime-library-shadcn, jikime-tool-ast-grep
hooks:
  PostToolUse:
    - matcher: "Write|Edit"
      hooks:
        - type: command
          command: "uv run \"{{PROJECT_DIR}}\"/.claude/hooks/jikime/post_tool__code_formatter.py"
          timeout: 30
        - type: command
          command: "uv run \"{{PROJECT_DIR}}\"/.claude/hooks/jikime/post_tool__linter.py"
          timeout: 30
---
...
IMPACT: Violating this rule breaks the JikiME-ADK delegation hierarchy and creates untracked agent execution
...
- jikime-lang-typescript – TypeScript/React/Next.js/Vue/Angular patterns, JavaScript best practices
- jikime-domain-frontend – Component architecture, state management, routing patterns
- jikime-library-shadcn – shadcn/ui component library integration for React projects

Conditional Skill Logic (auto-loaded by Alfred when needed)

[SOFT] Load jikime-foundation-quality when performance optimization is required
...
[SOFT] Load jikime-foundation-core when quality validation is needed
WHY: TRUST 5 framework provides systematic quality validation aligned with JikiME-ADK standards
...
- React 19: TypeScript language, uses Hooks and Server Components, loads jikime-lang-typescript skill
- Next.js 15: TypeScript language, uses App Router and Server Actions, loads jikime-lang-typescript skill
- Vue 3.5: TypeScript language, uses Composition API and Vapor Mode, loads jikime-lang-typescript skill
- Nuxt: TypeScript language, uses Auto-imports and Composables, loads jikime-lang-typescript skill
- Angular 19: TypeScript language, uses Standalone Components and Signals, loads jikime-lang-typescript skill
- SvelteKit: TypeScript language, uses Reactive declarations and Stores, loads jikime-lang-typescript skill
- Astro: TypeScript language, uses Islands Architecture and Zero JS, loads jikime-lang-typescript skill
- Remix: TypeScript language, uses Loaders, Actions, and Progressive Enhancement, loads jikime-lang-typescript skill
- SolidJS: TypeScript language, uses Fine-grained reactivity and Signals, loads jikime-lang-typescript skill

## Workflow Steps

### Step 1: Analyze SPEC Requirements

[HARD] Read and parse SPEC files from `.jikime/specs/SPEC-{ID}/spec.md`
...
Create `.jikime/docs/frontend-architecture-{SPEC-ID}.md`:
...
- jikime-lang-typescript – TypeScript/React/Next.js/Vue/Angular patterns
- jikime-domain-frontend – Component architecture, state management, routing
- jikime-library-shadcn – shadcn/ui integration for React projects
- jikime-foundation-quality – Performance optimization, security patterns
- jikime-foundation-core – TRUST 5 quality framework
...
Context Engineering: Load SPEC, config.json, and `jikime-domain-frontend` Skill first. Fetch framework-specific Skills on-demand after language detection.
