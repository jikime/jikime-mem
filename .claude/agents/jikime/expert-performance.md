...
skills: jikime-foundation-claude, jikime-lang-python, jikime-lang-typescript, jikime-lang-javascript, jikime-workflow-testing, jikime-foundation-quality
---
...
- jikime-lang-python – Python performance profiling and optimization patterns
- jikime-lang-typescript – TypeScript/JavaScript performance optimization patterns
- jikime-workflow-testing – Testing strategies and performance test patterns
...
Create `.jikime/docs/performance-analysis-{SPEC-ID}.md`:
