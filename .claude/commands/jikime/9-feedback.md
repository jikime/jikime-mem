...
# JikiME-ADK Step 9: Feedback Loop
...
Workflow Integration: This command implements the feedback loop of the JikiME workflow, allowing users to report issues or suggestions directly from the CLI.
...
/jikime:9-feedback performs feedback collection through agent delegation:

Execution Flow:

- User Command: /jikime:9-feedback [type]
