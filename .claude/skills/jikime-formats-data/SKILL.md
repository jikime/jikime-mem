...
- jikime-domain-backend - Backend data serialization and API responses
- jikime-domain-database - Database data format optimization
- jikime-foundation-core - MCP data serialization and transmission patterns
- jikime-workflow-docs - Documentation data formatting
- jikime-foundation-context - Context optimization for token budgets
...
Maintained by: JikiME-ADK Data Team
