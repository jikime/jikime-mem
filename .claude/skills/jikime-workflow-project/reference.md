# jikime-workflow-project Reference
...
```python
# Integration with /jikime:1-plan and /jikime:3-sync
from jikime_workflow_project import MoaiMenuProject

# Initialize project system
project = MoaiMenuProject("/path/to/project")

# After /jikime:1-plan generates SPEC
...
from jikime_workflow_project import TemplateOptimizer
...
- Project logs: `.jikime/logs/project.log`
- Template optimization logs: `.jikime/logs/template-optimizer.log`
- Language initialization logs: `.jikime/logs/language-init.log`
...
- JikiME-ADK Documentation: https://github.com/jikime-adk/docs
- Claude Code Skills Guide: https://docs.anthropic.com/claude-code/skills
- SPEC-First DDD Methodology: See `jikime-foundation-core/modules/spec-first-ddd.md`
...
- jikime-workflow-docs - Unified documentation management
- jikime-workflow-templates - Template optimization strategies
- jikime-library-nextra - Advanced documentation architecture
