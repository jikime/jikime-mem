# JikiME Workflow Project Examples
...
**Input**:
```python
from jikime_menu_project import MoaiMenuProject
...
```json
{
  ...
  "optimization_result": {
    "status": "success",
    "backup_created": ".jikime/backups/templates-2025-12-06-103000/",
    "files_optimized": 12,
    "size_reduction": {
      "before": "245KB",
      "after": "198KB",
...
```bash
# 프로젝트 초기화
python -m jikime_menu_project.cli init \
    --language ko \
    --domains backend,frontend

# SPEC에서 문서 생성
python -m jikime_menu_project.cli generate-docs \
    --spec-file .jikime/specs/SPEC-001.json

# 템플릿 최적화
python -m jikime_menu_project.cli optimize-templates \
    --backup \
    --dry-run  # 미리보기

# 문서 내보내기
python -m jikime_menu_project.cli export-docs \
    --format html \
    --language ko \
    --output ./dist/docs

# 프로젝트 상태 확인
python -m jikime_menu_project.cli status
```
