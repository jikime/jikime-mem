---
name: jikime-framework-electron
...
- jikime-lang-typescript - TypeScript patterns for type-safe Electron development
- jikime-domain-frontend - React, Vue, or Svelte renderer development
- jikime-lang-javascript - Node.js patterns for main process
- jikime-domain-backend - Backend API integration
- jikime-workflow-testing - Testing strategies for desktop apps
