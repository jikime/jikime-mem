---
name: "jikime-platform-firebase-auth"
...
related-skills: "jikime-platform-firestore, jikime-lang-flutter, jikime-lang-typescript"
allowed-tools:
  - Read
  - Write
  - Bash
...
- jikime-platform-firestore for Firestore database with auth-based security
- jikime-lang-flutter for Flutter SDK for mobile Firebase Auth
- jikime-lang-typescript for TypeScript patterns for Firebase SDK
- jikime-domain-backend for backend architecture with Firebase Admin SDK
