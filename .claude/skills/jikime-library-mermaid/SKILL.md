...
To invoke this skill, use the standard skill invocation pattern with the skill name jikime-library-mermaid.
...
### Integration with JikiME-ADK

This skill is designed for use within Claude Code during various development phases:

During the architecture phase with the jikime:1-plan command, create system design diagrams to visualize proposed solutions and component relationships.

During the documentation phase with the jikime:3-sync command, generate visual documentation including flowcharts, sequence diagrams, and architecture overviews.
...
Skills that complement this skill include jikime-docs-generation for comprehensive documentation generation, jikime-workflow-docs for diagram validation and documentation workflows, and jikime-library-nextra for architecture documentation sites.

Commands that utilize this skill include jikime:3-sync for documentation with embedded diagrams and jikime:1-plan for SPEC creation with visual architecture diagrams.
