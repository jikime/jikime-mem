...
- `jikime-lang-go` - Go systems programming patterns
- `jikime-domain-backend` - REST API architecture and microservices patterns
- `jikime-foundation-quality` - Security hardening for Rust applications
- `jikime-workflow-testing` - Test-driven development workflows
