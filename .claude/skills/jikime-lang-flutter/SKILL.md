...
related-skills: ['jikime-lang-swift', 'jikime-lang-kotlin']
updated: 2026-01-11
status: "active"
---
...
- `jikime-lang-swift` - iOS native integration for platform channels
- `jikime-lang-kotlin` - Android native integration for platform channels
- `jikime-domain-backend` - API integration and backend communication
- `jikime-quality-security` - Mobile security best practices
- `jikime-essentials-debug` - Flutter debugging and DevTools
