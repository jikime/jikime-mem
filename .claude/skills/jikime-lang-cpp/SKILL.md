...
- `jikime-lang-rust` - Systems programming comparison and interop
- `jikime-domain-backend` - Backend service architecture
- `jikime-workflow-testing` - DDD and testing strategies
- `jikime-essentials-debug` - Debugging and profiling
- `jikime-foundation-quality` - TRUST 5 quality principles
