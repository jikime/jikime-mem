...
- jikime-lang-typescript for TypeScript integration and type checking with JSDoc
- jikime-domain-backend for API design and microservices architecture
- jikime-domain-database for database integration and ORM patterns
- jikime-workflow-testing for DDD workflows and testing strategies
- jikime-foundation-quality for code quality standards
- jikime-essentials-debug for debugging JavaScript applications
