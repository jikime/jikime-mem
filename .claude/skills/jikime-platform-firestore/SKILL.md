---
name: "jikime-platform-firestore"
...
related-skills: ['jikime-platform-firebase-auth', 'jikime-lang-flutter', 'jikime-lang-typescript']
allowed-tools:
  - Read
  - Write
  - Bash
...
# jikime-platform-firestore: Firebase Firestore Specialist
...
- jikime-platform-firebase-auth for Firebase Authentication integration
- jikime-lang-flutter for Flutter SDK patterns
- jikime-lang-typescript for TypeScript client patterns
- jikime-domain-mobile for mobile architecture patterns
- jikime-quality-security for Security Rules best practices
...
Generated with: JikiME-ADK Skill Factory v2.0
