...
related-skills: ['jikime-lang-kotlin', 'jikime-domain-backend']
updated: 2026-01-11
status: "active"
---
...
- jikime-lang-kotlin for Kotlin interoperability and Spring Kotlin extensions
- jikime-domain-backend for REST API, GraphQL, and microservices architecture
- jikime-domain-database for JPA, Hibernate, and R2DBC patterns
- jikime-foundation-quality for JUnit 5, Mockito, and TestContainers integration
- jikime-infra-docker for JVM container optimization
