...
related-skills: ['jikime-platform-supabase', 'jikime-lang-typescript', 'jikime-domain-database']
updated: 2026-01-11
status: "active"
allowed-tools:
  - Read
...
# jikime-platform-neon: Neon Serverless PostgreSQL Specialist
...
- jikime-platform-supabase for alternative when RLS or pgvector needed
- jikime-lang-typescript for TypeScript patterns for Drizzle and Prisma
- jikime-domain-backend for backend architecture with database integration
- jikime-domain-database for general database patterns and optimization
