...
class AlfredAgentCoordinator:
 ...
 def __init__(self):
 self.debug_agent = "jikime-essentials-debug"
 self.perf_agent = "jikime-essentials-perf"
 self.review_agent = "jikime-essentials-review"
 self.trust_agent = "jikime-foundation-trust"
