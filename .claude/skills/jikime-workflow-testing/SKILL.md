...
triggers:
  keywords: ["DDD", "test-driven development", "debugging", "performance optimization", "code review", "PR review", "quality assurance", "testing", "CI/CD", "TRUST 5"]
  phases: ["run", "sync"]
...
Unified Development Workflow provides comprehensive development lifecycle management combining DDD, AI-powered debugging, performance optimization, automated code review, and quality assurance into integrated workflows.

Core Capabilities:

- Test-Driven Development: ANALYZE-PRESERVE-IMPROVE cycle with best practice patterns
...
Component 4 - DDD Cycle Management: The DDD component guides the ANALYZE-PRESERVE-IMPROVE cycle with enhanced test generation. It helps write failing tests first, implement minimal code to pass, then refactor while maintaining test coverage.
...
- jikime-domain-backend: Backend development workflows and API testing patterns
- jikime-domain-frontend: Frontend development workflows and UI testing strategies
- jikime-foundation-core: Core SPEC system and workflow management integration
- jikime-platform-supabase: Supabase-specific testing patterns and database testing
- jikime-platform-vercel: Vercel deployment testing and edge function validation
- jikime-platform-firebase-auth: Firebase authentication testing patterns
- jikime-workflow-project: Project management and documentation workflows
...
Maintained by: JikiME-ADK Development Workflow Team
