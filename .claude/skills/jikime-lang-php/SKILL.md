...
- jikime-domain-backend for REST API and microservices architecture
- jikime-domain-database for SQL patterns and ORM optimization
- jikime-workflow-testing for DDD and testing strategies
- jikime-platform-deploy for Docker and deployment patterns
- jikime-essentials-debug for AI-powered debugging
- jikime-foundation-quality for TRUST 5 quality principles
