...
- `jikime-domain-backend` - API design, database integration patterns
- `jikime-platform-deploy` - Azure, Docker, Kubernetes deployment
- `jikime-workflow-testing` - Testing strategies and patterns
- `jikime-foundation-quality` - Code quality standards
- `jikime-essentials-debug` - Debugging .NET applications
