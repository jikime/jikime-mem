...
related-skills: "jikime-platform-supabase, jikime-lang-typescript, jikime-domain-frontend"
updated: 2026-01-11
status: "active"
allowed-tools:
  - Read
...
- jikime-platform-supabase for alternative PostgreSQL-based backend
- jikime-lang-typescript for TypeScript patterns and best practices
- jikime-domain-frontend for React integration patterns
- jikime-platform-clerk for Clerk authentication patterns
- jikime-platform-auth0 for Auth0 authentication patterns
