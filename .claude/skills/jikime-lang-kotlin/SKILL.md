...
related-skills: "jikime-lang-java, jikime-lang-swift"
updated: 2026-01-11
status: "active"
---
...
- `jikime-lang-java` - Java interoperability and Spring Boot patterns
- `jikime-domain-backend` - REST API, GraphQL, microservices architecture
- `jikime-domain-database` - JPA, Exposed, R2DBC patterns
- `jikime-quality-testing` - JUnit 5, MockK, TestContainers integration
- `jikime-infra-docker` - JVM container optimization
