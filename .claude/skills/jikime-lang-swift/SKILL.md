...
related-skills: ['jikime-lang-kotlin', 'jikime-lang-flutter']
updated: 2026-01-11
status: "active"
---
...
- `jikime-lang-kotlin` - Android counterpart for cross-platform projects
- `jikime-lang-flutter` - Flutter/Dart for cross-platform mobile
- `jikime-domain-backend` - API integration and backend communication
- `jikime-foundation-quality` - iOS security best practices
- `jikime-workflow-testing` - Xcode debugging and profiling
