...
related-skills: ['jikime-platform-vercel', 'jikime-domain-backend']
updated: 2026-01-11
status: "active"
allowed-tools:
  - Read
...
# jikime-platform-railway: Container Deployment Specialist
...
- jikime-platform-vercel for edge deployment for frontend
- jikime-domain-backend for backend architecture patterns
- jikime-lang-python for Python FastAPI deployment
- jikime-lang-typescript for TypeScript Node.js patterns
- jikime-lang-go for Go service deployment
