...
- jikime-tdd-implementation - DDD workflow validation
- jikime-security-owasp - Security compliance
- jikime-context7-integration - Context7 best practices
- jikime-performance-optimization - Performance analysis

Commands:

- /jikime:2-run - DDD validation integration
- /jikime:3-sync - Documentation quality checks
- /jikime:9-feedback - Quality improvement feedback
