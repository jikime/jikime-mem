...
related-skills: "jikime-platform-railway, jikime-lang-typescript, jikime-domain-frontend"
updated: 2026-01-11
status: "active"
allowed-tools:
  - Read
...
# jikime-platform-vercel: Vercel Edge Deployment Specialist
...
- jikime-platform-railway for container-based deployment alternative
- jikime-lang-typescript for TypeScript patterns for Next.js
- jikime-domain-frontend for React and Next.js component patterns
- jikime-foundation-quality for deployment validation and testing
- jikime-domain-database for database patterns for Vercel Postgres
