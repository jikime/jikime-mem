...
related-skills: ['jikime-lang-rust', 'jikime-domain-backend']
updated: 2026-01-11
status: "active"
---
...
- jikime-domain-backend for REST API architecture and microservices
- jikime-lang-rust for systems programming companion
- jikime-quality-security for security hardening
- jikime-essentials-debug for performance profiling
- jikime-workflow-ddd for test-driven development
