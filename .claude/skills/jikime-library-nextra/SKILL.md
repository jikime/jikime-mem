...
Complementary skills include jikime-docs-generation for auto-generating docs from code, jikime-workflow-docs for validating documentation quality, and jikime-cc-claude-md for Markdown formatting.
...
- jikime-docs-generation for content generation
- jikime-workflow-docs for documentation validation
- jikime-library-mermaid for diagram integration

Commands:

- jikime:3-sync for documentation deployment
- jikime:0-project for Nextra project initialization
