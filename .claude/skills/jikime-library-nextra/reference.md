# jikime-library-nextra Reference
...
- `jikime-docs-generation`: Automated documentation generation
- `jikime-workflow-docs`: Documentation workflow management
- `jikime-domain-frontend`: Frontend development patterns
- `jikime-library-mermaid`: Diagram integration
