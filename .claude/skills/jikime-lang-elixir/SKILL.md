...
- `jikime-domain-backend` - REST API and microservices architecture
- `jikime-domain-database` - SQL patterns and query optimization
- `jikime-workflow-testing` - DDD and testing strategies
- `jikime-essentials-debug` - AI-powered debugging
- `jikime-platform-deploy` - Deployment and infrastructure
