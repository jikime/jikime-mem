...
- jikime-lang-java - JVM interoperability, Spring Boot integration
- jikime-domain-backend - REST API, GraphQL, microservices patterns
- jikime-domain-database - Doobie, Slick, database patterns
- jikime-workflow-testing - ScalaTest, MUnit, property-based testing
