...
related-skills: ['jikime-platform-neon', 'jikime-lang-typescript']
updated: 2026-01-11
status: "active"
allowed-tools:
  - Read
...
# jikime-platform-supabase: Supabase Platform Specialist
...
- jikime-platform-neon for alternative PostgreSQL for specific use cases
- jikime-lang-typescript for TypeScript patterns for Supabase client
- jikime-domain-backend for backend architecture integration
- jikime-foundation-quality for security and RLS best practices
- jikime-workflow-testing for test-driven development with Supabase
