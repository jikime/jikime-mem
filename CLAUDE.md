...
Configuration: @.jikime/config/sections/quality.yaml (constitution.development_mode: ddd)
...
Version: 10.4.1 (Rules Separation + Coding Style & Git Workflow)
